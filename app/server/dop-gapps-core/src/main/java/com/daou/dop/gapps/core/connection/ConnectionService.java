package com.daou.dop.gapps.core.connection;
...
import com.daou.dop.gapps.core.repository.OAuthCredentialRepository;
...
public class ConnectionService implements CredentialProvider {
    ...
    public Long createSimpleConnection(String pluginId, String externalId, String externalName) {
        ...
        PluginConnection connection = PluginConnection.builder()
                .pluginId(pluginId)
                .scopeType(com.daou.dop.gapps.domain.enums.ScopeType.USER)
                .externalId(externalId)
    ...
    private ScopeType toCoreScopeType(com.daou.dop.gapps.domain.enums.ScopeType domainType) {
    ...
    private com.daou.dop.gapps.domain.enums.ScopeType toDomainScopeType(ScopeType coreType) {
        if (coreType == null) return com.daou.dop.gapps.domain.enums.ScopeType.WORKSPACE;
        return switch (coreType) {
            case WORKSPACE -> com.daou.dop.gapps.domain.enums.ScopeType.WORKSPACE;
            case USER -> com.daou.dop.gapps.domain.enums.ScopeType.USER;
        };
    }
}
